...
python srf2spotify.py -a $@ --id 4Ldq3hOfxSf6vKqwMoBmSm $SPOTIFY_USERNAME http://podcasts.srf.ch/srf_3_punkt_ch_mpx.xml
# https://open.spotify.com/user/aarnoaukia/playlist/4Ldq3hOfxSf6vKqwMoBmSm
